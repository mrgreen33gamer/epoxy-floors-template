...
// PolyCoat Floors — Contact Page (unique build, not just a form import)
...
const faq = [
  {
    question: "What's the fastest way to get a free quote?",
    answer: "Call us directly at (254) 980-1919 or fill out the form below. We respond to most requests within one business day and can usually schedule an on-site measure within the week.",
  },
  {
    question: 'How far in advance should I book?',
    answer: "Most residential installs schedule within 1–2 weeks of your estimate. Busy spring and fall seasons fill faster — we'll give you an honest timeline when you call.",
  },
  {
    question: 'Do you charge for the estimate visit?',
    answer: 'No — on-site quotes are always free, with no obligation to book. We measure, check grade and access, and leave you with a firm written price.',
  },
  {
    question: 'Do you handle commercial floor coating projects?',
    answer: 'Yes — offices, retail spaces, restaurants, and multi-unit properties are all within our scope. We can schedule after-hours or phased installs to minimize disruption. Call to discuss your project.',
  },
  {
    question: 'What areas do you serve?',
    answer: 'Waco, Hewitt, Woodway, McGregor, China Spring, Bellmead, Temple, Killeen, and most of Central Texas. Call us — we probably cover your area.',
  },
  {
    question: 'How do I know if I need a repair or a full replacement?',
    answer: "Our installer will tell you honestly after the assessment. If repair or refinish will restore the epoxy, we recommend that first — full replacement only when it makes sense. We'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Epoxy Done Right</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@polycoatfloors.com',
                  href:      'mailto:hello@polycoatfloors.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '3300 Lake Air Dr, Waco TX 76710',
                  href:      'https://maps.google.com/?q=1800+S+University+Parks+Dr+Waco+TX+76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose PolyCoat</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '5-Year Coating Warranty on every install',
                'crew-coated, licensed installers only',
                'Free on-site measures & samples',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A PolyCoat specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12549801919">(254) 980-1919</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request a Free On-Site Quote</h2>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <button type="submit" disabled={isSubmitting} className={styles.submitBtn}>
                      {isSubmitting
                        ? <PulseLoader size={8} color="#1a1025" />
                        : (
                          <>
      ...
      <CTABanner
        ...
        subline="Call (254) 980-1919 — free on-site quotes, flat-rate pricing, 5-Year Coating Warranty."
        primaryText="Call (254) 980-1919"
        primaryLink="tel:+12549801919"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547153900"
      />
