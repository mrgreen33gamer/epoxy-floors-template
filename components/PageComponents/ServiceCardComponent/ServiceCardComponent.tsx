...
export default function ServiceCardComponent({
  cards,
  heading    = 'Everything Your Garage floor & Home Needs',
  subheading = 'From garage epoxy floors to commercial floor coating, PolyCoat handles it all — on time, on price.',
