...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Epoxyry Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — materials, custom vs semi-custom, and when to refinish or replace.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
