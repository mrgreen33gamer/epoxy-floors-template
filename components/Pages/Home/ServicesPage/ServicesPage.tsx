  ...
  return (
    ...
    >
      ...
      <nav aria-label="Services navigation" style={{
        ...
        <Link href="/services">All Services — PolyCoat Floors</Link>
      </nav>

      <span id={styles.backgroundImage}>
        <Image quality={100} fill style={{ objectFit: 'cover' }} sizes="100vw" src='/pages/home/services/background-image.png?v=3' alt="Background Image for Services Page - PolyCoat Floors - Background" />
      </span>
    ...
    >
      ...
      >
        <Image
          ...
          src={imgSrc}
          quality={100}
          alt={`${imgAlt} - PolyCoat Floors - Waco TX`}
        />
      </motion.div>
    </motion.div>
  );
